select m.FirstName AS "First Name", m.LastName AS "Last Name", ds.DiagnosisID as "Diagnosis ID", ds.DiagnosisDescription as "Diagnosis Description", dc.DiagnosisCategoryID as "Category ID", dc.CategoryDescription as "Category Description", dc.CategoryScore as "Category Score",
cast(case
